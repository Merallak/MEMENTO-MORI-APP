...
export const translations = {
  en: {
    ...
    trading: {
      ...
      not_eligible_desc: "You must exchange 1% equity for MMC in the Game Room to access the AMM.",
      go_to_game_room: "Go to Game Room",
      select_token: "Select a token",
      buy_title: "Buy {{ticker}}",
      sell_title: "Sell {{ticker}}",
      amount: "Amount",
      mmc_to_spend: "MMC to spend",
      tokens_to_sell: "Tokens to sell",
      you_receive: "You receive",
      you_spend: "You spend",
      price_per_token: "Price per token",
      pool_reserves: "Pool Reserves",
      mmc_reserve: "MMC Reserve",
      token_reserve: "Token Reserve",
      current_price: "Current Price",
      buy_button: "Buy with MMC",
      sell_button: "Sell for MMC",
      success_buy: "Successfully purchased {{amount}} {{ticker}}",
      success_sell: "Successfully sold {{amount}} {{ticker}}",
      error_generic: "Transaction failed",
      no_pools: "No liquidity pools available",
      your_mmc_balance: "Your MMC Balance",
      your_token_balance: "Your {{ticker}} Balance",
    },
  ...
  es: {
    ...
    amm: {
      title: "Intercambio AMM",
      subtitle: "Intercambia tokens con MMC usando el creador de mercado automatizado",
      not_eligible_title: "Acceso Restringido",
      not_eligible_desc: "Debes intercambiar 1% de equity por MMC en la Sala de Juegos para acceder al AMM.",
      go_to_game_room: "Ir a Sala de Juegos",
      select_token: "Selecciona un token",
      buy_title: "Comprar {{ticker}}",
      sell_title: "Vender {{ticker}}",
      amount: "Cantidad",
      mmc_to_spend: "MMC a gastar",
      tokens_to_sell: "Tokens a vender",
      you_receive: "Recibes",
      you_spend: "Gastas",
      price_per_token: "Precio por token",
      pool_reserves: "Reservas del Pool",
      mmc_reserve: "Reserva MMC",
      token_reserve: "Reserva de Tokens",
      current_price: "Precio Actual",
      buy_button: "Comprar con MMC",
      sell_button: "Vender por MMC",
      success_buy: "Compraste {{amount}} {{ticker}} exitosamente",
      success_sell: "Vendiste {{amount}} {{ticker}} exitosamente",
      error_generic: "La transacción falló",
      no_pools: "No hay pools de liquidez disponibles",
      your_mmc_balance: "Tu Balance MMC",
      your_token_balance: "Tu Balance de {{ticker}}",
    },
